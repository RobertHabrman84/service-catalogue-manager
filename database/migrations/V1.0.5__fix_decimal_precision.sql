...
BEGIN
    ...
    BEGIN
        ...
        PRINT '✅ EffortEstimationItem.EffortDays updated successfully';
    END
    ELSE
    BEGIN
        PRINT 'ℹ️  EffortEstimationItem.EffortDays already has decimal(18,2) precision';
    END
END
ELSE
BEGIN
    PRINT '⚠️  Table EffortEstimationItem or column EffortDays does not exist';
END
GO
...
BEGIN
    ...
    BEGIN
        ...
        PRINT '✅ ServiceTeamAllocation.AllocationPercentage updated successfully';
    END
    ELSE
    BEGIN
        PRINT 'ℹ️  ServiceTeamAllocation.AllocationPercentage already has decimal(18,2) precision';
    END
END
ELSE
BEGIN
    PRINT '⚠️  Table ServiceTeamAllocation or column AllocationPercentage does not exist';
END
GO
...
-- ============================================================
PRINT '✅ Migration V1.0.5 completed successfully';
GO